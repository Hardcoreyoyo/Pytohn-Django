...
urlpatterns = [
    ...
    url(r"^password/change/key/(?P<uidb36>[0-9A-Za-z]+)-(?P<key>.+)/$",
        views.password_change_from_key,
        name="account_change_password_from_key"),
    url(r"^password/change/from/key/done/$", views.password_change_from_key_done,
        name="account_change_password_from_key_done"),
