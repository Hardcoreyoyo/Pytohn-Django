...
class ChangePasswordForm(PasswordVerificationMixin, UserForm):
    ...
    def save(self, request, **kwargs):
        ...
        for user in self.users:
            ...
            path = reverse("account_change_password_from_key",
            ...
            get_adapter(request).send_mail(
                'account/email/password_change_key',
                email,
                context)
        return self.cleaned_data["email"]
...
class ChangePasswordKeyForm(PasswordVerificationMixin, forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(ChangePasswordKeyForm, self).__init__(*args, **kwargs)
